  ...
  <Layout>
    ...
    <div className="sdm-layout__block sdm-layout__block--multisection">
      <section className="sdm-layout__section">
        ...
        <ul>
          <li><a rel="external" href="https://twitter.com/iamdidev">Twitter</a></li>
          <li><a rel="external" href="https://github.com/iamdidev">Github</a></li>
          <li><a rel="external" href="https://codepen.io/iamdidev/">Codepen</a></li>
        </ul>
      </section>
      <section className="sdm-layout__section">
